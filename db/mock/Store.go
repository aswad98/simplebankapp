...
// Source: github.com/minibank/db/sqlc (interfaces: Store)
...
// ListOfAccounts mocks base method.
func (m *MockStore) ListOfAccounts(arg0 context.Context, arg1 db.ListOfAccountsParams) ([]db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListOfAccounts", arg0, arg1)
	ret0, _ := ret[0].([]db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListOfAccounts indicates an expected call of ListOfAccounts.
func (mr *MockStoreMockRecorder) ListOfAccounts(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListOfAccounts", reflect.TypeOf((*MockStore)(nil).ListOfAccounts), arg0, arg1)
}
